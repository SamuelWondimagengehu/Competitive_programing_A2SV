class Solution:
    def multiply_one_digit(self, digit2: str, num_zeros: int, first_number: List[str]) -> List[str]:
    ...
    def sum_results(self, results: List[str]) -> List[str]:
        answer = results.pop()
    ...
    def multiply(self, num1: str, num2: str) -> str:
        ...
        first_number, second_number = num1[::-1], num2[::-1]
        results = []
